...
dataset=pd.read_csv('D:/Finish_2/dataset/2_test_2d_train.csv')#文件读取71500
...
"""#參考VGG16
model.add(Conv2D(filters=64, kernel_size=(3, 3), strides=1,  padding='same', input_shape=(13, 13, 1), activation='relu'))
model.add(Conv2D(filters=64, kernel_size=(3, 3), strides=1, padding='same', activation='relu'))
#model.add(MaxPooling2D((2, 2), strides=(2, 2), padding='same'))

model.add(Conv2D(filters=96, kernel_size=(3, 3), strides=1, padding='same', activation='relu'))
model.add(Conv2D(filters=96, kernel_size=(3, 3), strides=1, padding='same', activation='relu'))
#model.add(MaxPooling2D((2, 2), strides=(2, 2), padding='same'))
...
model.add(Conv2D(filters=256, kernel_size=(3, 3), strides=2, padding='same', activation='relu'))
model.add(Conv2D(filters=256, kernel_size=(3, 3), strides=2, padding='same', activation='relu'))
model.add(Conv2D(filters=256, kernel_size=(3, 3), strides=2, padding='same', activation='relu'))"""
...
train_history = model.fit(x=train_data_2D, y=train_label_onehot, validation_data=(val_data_2D, val_label_onehot), callbacks=[EarlyStop, Reduce], epochs=20, batch_size=128, verbose=2)
